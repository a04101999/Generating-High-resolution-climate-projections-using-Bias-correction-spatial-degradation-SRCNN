...
json_file = open('/home/madhumadi/sd/miroc_bcsd_ds_full_elevation_1_e_2000/srcnn_pred_miroc_bcsd_ds_full_elevation_1_e_2000_16_06.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("/home/madhumadi/sd/miroc_bcsd_ds_full_elevation_1_e_2000/srcnn_weights_miroc_bcsd_ds_full_elevation_1_e_2000_16_06.h5")
...
name='miroc_bcsd_ds_{data_size}_elevation_{use_elevation}_e_{n_epochs}'.format(data_size=ds,use_elevation=use_elevation,n_epochs=n_epochs)
name
...
x1=xr.open_dataset('/home/madhumadi/sd/nc_files/obs_1920_to_2005_no_leap.nc')['precipitation (mm)']
y1=xr.open_dataset('/home/madhumadi/sd/nc_files/mirac_bcsd_output.nc')['observation']
...
print('saving')
xr_object = xr.Dataset({"miroc_bcsrcnn": (('time', 'lat', 'lon'), predict)},coords={"lat": x.lat.values, "lon": x.lon.values, "time": xr.cftime_range('1920-01-01','2005-12-31', calendar='noleap')})

xr_object.to_netcdf('/home/madhumadi/sd/nc_files/miroc_bcsrcnn.nc')
